...
8. `tools/eval/eval_self_instruct_public_seed_folds.py`
...
7. `tools/analysis/audit_public20_reference.py`로 public20 reference용 label-free qualitative audit pack을 생성했다.
