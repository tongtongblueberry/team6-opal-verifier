...
active datagen은 public20 input-only seed contract와 generated candidate contract만 담당한다. →
[Detailed Explanation/Example] ad-hoc fixture/smoke generated data is not accepted synthetic data.
real LLM generation을 붙일 때도 v4/v4.1, spec/gap generator, 임의 deterministic fixture
generator를 import하거나 active surface에 두면 안 된다.
