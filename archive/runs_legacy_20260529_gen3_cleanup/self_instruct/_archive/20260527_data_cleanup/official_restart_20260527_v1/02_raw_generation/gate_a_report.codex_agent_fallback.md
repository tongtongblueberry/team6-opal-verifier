...
- 전체 candidate 수: 11
- hard invariant pass 수: 11
- hard invariant fail 수: 0
- 요청 sample 수: 11
- 실제 audit pack sample 수: 11
- seed: 20260527

## Label 분포

- Accepted pool: `{"fail": 3, "pass": 8}`
- Audit sample: `{"fail": 3, "pass": 8}`
...
- line 11, sample_id `codex-agent-fallback-self-instruct-gen-00003-03`, label `pass`, final `Set/INVALID_PARAMETER`
