...
|---|---:|---:|---:|---|
| train | 16 | 8 | 8 | `runs/model_validation/public20_trl_sft/datasets/retrieved_seed_47/train.jsonl` |
| validation | 4 | 2 | 2 | `runs/model_validation/public20_trl_sft/datasets/retrieved_seed_47/validation.jsonl` |
