...
# Changed: run RETRAIN-20 augmented public20 validation comparison from an ops run-root snapshot.
# Why: generated fallback rows are experimental comparison data only, and public20 validation must stay byte-identical to the baseline validation files.
...
DATASET_BASE=runs/model_validation/public20_trl_sft_10_10_augmented20/20260527_230901_KST/datasets
MAX_LENGTH=8192
LEARNING_RATE=1e-5
